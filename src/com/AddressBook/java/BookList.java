...
public class BookList {
    ...
    void showPersonsByCity(String placeName) throws IOException {
        ...
        File dir = new File(
                "C:\\Users\\Amar\\Desktop\\RFP-Java-Basics\\Day 22\\src\\com\\AddressBook\\java");
    ...
    void showPersonsByState(String placeName) throws IOException {
        ...
        ArrayList<String> lines = new ArrayList<String>();
        File dir = new File(
                "C:\\Users\\Amar\\Desktop\\RFP-Java-Basics\\Day 22\\src");
        File[] directoryListing = dir.listFiles();
        BufferedReader reader;
        if (directoryListing != null) {
            for (File child : directoryListing) {
    ...
    int checkBook(String name) throws IOException {
        ...
        int track = 0;
        File file = new File(
                "C:\\Users\\Amar\\Desktop\\RFP-Java-Basics\\Day 22\\src" + name
                        + ".txt");
        if (!file.exists()) {
